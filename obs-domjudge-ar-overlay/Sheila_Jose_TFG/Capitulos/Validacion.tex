...
\chapterquote{Andorra es el reino de la nieve, donde el invierno ha prohibido la prisa}{Joan Margarit}
...
La validación funcional del sistema se ha llevado a cabo mediante una demostración grabada en vídeo en la que se ejercitan, de forma secuencial, los cuatro modos de operación del complemento sobre una escena real de OBS Studio. El vídeo está disponible públicamente\footnote{\url{https://drive.google.com/file/d/12J0AZ0UPVh4zQVe7GQUkSkUPGKlrXgVd/view?usp=sharing}} \citep{VideoValidacion} y constituye la evidencia principal de que el sistema se comporta correctamente en condiciones reales de retransmisión.
