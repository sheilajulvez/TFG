...
As a result, the system demonstrates the feasibility of integrating live AR into OBS Studio through its native plugin architecture. Furthermore, it opens the door to its adaptation to other types of live broadcasts beyond programming contests. The complete source code of the tool is available in the project's public repository\footnote{\url{https://github.com/sheilajulvezcognifit/TFG}} \citep{PluginRepo}.

\section{Work Plan}

The project will be organized into four consecutive phases following an iterative applied research methodology. Each phase has a specific objective and produces a deliverable that serves as the starting point for the next one. Table~\ref{tab:work_plan_en} summarizes the general planning.
