...
Este apéndice describe el proceso de instalación del plugin \textit{SheilaJosePluginTest} en OBS Studio. El plugin ha sido compilado para Windows de 64 bits y ha sido desarrollado y validado específicamente para OBS Studio 31.x (31.0.0). No se garantiza su funcionamiento correcto en otras versiones principales de OBS Studio.

\section*{Requisitos previos}

\begin{itemize}
  \item OBS Studio 31.x, arquitectura 64 bits, instalado en el sistema.
...
Esta carpeta contiene los shaders del renderizador, el modelo 3D del reloj (\texttt{reloj.fbx}, \texttt{reloj.obj}), ficheros de ejemplo de configuración y los archivos de localización.
...
\begin{itemize}
  ...
  \item La versión de OBS Studio pertenece a la rama 31.x y es la de 64 bits.
