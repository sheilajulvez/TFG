...
Este apéndice describe el proceso de instalación del plugin \textit{SheilaJosePluginTest} en OBS Studio. El plugin ha sido compilado para Windows de 64 bits y ha sido desarrollado para OBS Studio 31.1.12. No se garantiza su funcionamiento correcto en otras versiones.

\section*{Requisitos previos}

\begin{itemize}
  \item OBS Studio 31.1.12, arquitectura 64 bits, instalado en el sistema.
...
\begin{itemize}
  ...
  \item La versión de OBS Studio es 31.1.12 y es la de 64 bits.
