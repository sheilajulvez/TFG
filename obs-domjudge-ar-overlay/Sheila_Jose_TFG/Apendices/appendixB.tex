...
\begin{itemize}
  ...
  \item \textbf{Rotacion X / Y / Z (Grados)} — orientación del modelo en cada eje (rango $-360^\circ$ a $360^\circ$).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{AR Offset Rotacion X / Y / Z} — corrección de orientación sobre los ejes del marcador (rango $-360^\circ$ a $360^\circ$).
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Manecillas Reloj} — modo de animación de las mallas del modelo:
    \begin{itemize}
      \item \textbf{H/M/S (3)} — tres manecillas independientes (hora, minuto, segundo). La manecilla de segundos avanza $6^\circ$ por segundo, la de minutos $6^\circ$ por minuto completado, y la de horas de forma proporcional al rango configurado.
      \item \textbf{Total (1)} — una única manecilla que barre $360^\circ$ a lo largo de toda la duración configurada, representando el progreso total del concurso.
    \end{itemize}
