...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tituloPortada{%
Realidad aumentada para Retransmisiones en directo
%\textcolor{red}{(definido en Cascaras$\backslash$cover.tex)}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\tituloPortadaEng{
Augmented Reality for Live Streaming 
%{(defined in Cascaras$\backslash$cover.tex)}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\autorPortada{Sheila Julvez López y Jose Moreno Barbero}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\directorPortada{Pedro Pablo Gomez Martín y Marco Antonio Gómez Martín}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Colaborador en la dirección del trabajo.
 \colaboradorPortada{UCM}
% Se utiliza para el valor por defecto del segundo subtítulo, donde
...
\textbf{Trabajo de Fin de Grado en Desarrollo de Videojuegos}
}
...
\textbf{Convocatoria: }\textit {Febrero \the\year}\\[0.2em]
