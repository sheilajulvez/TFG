...
La más relevante desde el punto de vista técnico es la incorporación de \textbf{seguimiento sin marcadores}. Las técnicas actuales de SLAM visual permitirían anclar los overlays a superficies del entorno real sin necesidad de imprimir y colocar códigos ArUco en las mesas, lo que haría el sistema más flexible y aplicable a escenarios donde no se puede controlar el espacio físico.
